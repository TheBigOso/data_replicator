...
- Domain: Enterprise CDC Replication Platform (Rust agents, hub-routed, competes with HVR/GoldenGate/Qlik Replicate). Design docs live in `uploads/repidata/Documents/` — read them before building UI.
